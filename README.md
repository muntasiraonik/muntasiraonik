...
1. **[DineDash]** - It's a clone of Lieferando.de. [Uni Project]
   - Restaurant owners can create and set up profiles, upload their menus and drinks.
   - Users can create an account, place orders, and give reviews.
   

2. **[Code Snippet Manager]** - [Live Link](https://code-snippet-manager.vercel.app/)
   - Brief description of Project 2. 

3. **[Netzwerk Words]** - [Live Link](https://netzwerk-words.vercel.app/)
...
- Web Development: [HTML, CSS, Gatsby, Next Js.]

## Connect with Me 🤝

- LinkedIn: [https://www.linkedin.com/in/muntasiraonik/]
- Twitter: [https://twitter.com/muntasiraonik]

## Fun Facts 😜

- I enjoy playing games. [Recent Fav is RDR2 & Mostly Played CSGO]
- My favorite programming language is Python.

## WorkStation 💻

- Device: Mac Book Pro with Apple M2 Pro Chip
